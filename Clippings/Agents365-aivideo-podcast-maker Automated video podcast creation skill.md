---
title: "Agents365-ai/video-podcast-maker: Automated video podcast creation skill"
source: "https://github.com/Agents365-ai/video-podcast-maker"
author:
  - "[[GitHub]]"
published:
created: 2026-03-20
description: "Automated video podcast creation skill. Contribute to Agents365-ai/video-podcast-maker development by creating an account on GitHub."
tags:
  - "clippings"
---
## 视频播客生成器

[English](https://github.com/Agents365-ai/video-podcast-maker/blob/main/README_EN.md)
...
[![OpenClaw x Video Podcast Maker](https://github.com/Agents365-ai/video-podcast-maker/raw/main/assets/openclaw-collaboration.png)](https://github.com/Agents365-ai/video-podcast-maker/blob/main/assets/openclaw-collaboration.png)
...
[![工作流程](https://github.com/Agents365-ai/video-podcast-maker/raw/main/assets/workflow.png)](https://github.com/Agents365-ai/video-podcast-maker/blob/main/assets/workflow.png)
...
- 组件模板库 (ComparisonCard, Timeline, CodeBlock, QuoteBlock, FeatureGrid, DataBar, StatCounter, FlowChart, IconCard)
- 广播级画质升级（渐变背景、多层阴影、动画计数器、质量检查清单）
- 多 TTS 引擎支持 (Azure Speech + CosyVoice + Edge TTS)
- Edge TTS 免费后端（无需 API 密钥）
- 断点续传（ `--resume` 参数）
- 预估模式（ `--dry-run` 预估时长，不调用 API）
- 用户偏好自我进化（自动学习视觉/TTS/内容风格偏好）
